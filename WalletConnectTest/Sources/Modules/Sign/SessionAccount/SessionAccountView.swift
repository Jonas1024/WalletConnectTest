...
struct SessionAccountView: View {
    @ObservedObject var presenter = SessionAccountPresenter()
    ...
    init(
        ...
        presenter.sessionAccount = sessionAccount
//        let presenter = SessionAccountPresenter(sessionAccount: sessionAccount, session: session)
